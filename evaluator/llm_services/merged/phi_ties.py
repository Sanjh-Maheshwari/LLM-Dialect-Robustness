...
ADAPTER_DIR = "/scratch/users/k24053411/axolotl/phi_3"
...
class Phi3Classifier:
    ...
    def load_merged_dialect_adapter(self, task: str, domain: str):
        ...
        if adapter_name not in self.peft_models: 
            ...
            adapter_path = os.path.join(ADAPTER_DIR, f"{self.dialects[0]}_{task}_{domain}_adapter")
            ...
            adapters.append(self.dialects[0])

            # Add the remaining adatpers
        ...
        self.model.add_weighted_adapter(adapters, weights, adapter_name, combination_type=combination_type, density=density)
