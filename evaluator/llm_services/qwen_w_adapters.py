...
ADAPTER_DIR = "/scratch/users/k24053411/axolotl/qwen"
...
class QwenStoppingCriteria(StoppingCriteria):
    def __init__(self, tokenizer, stop_strings=None):
        if stop_strings is None:
            # Qwen2.5 uses these special tokens
...
class QwenClassifier:
    """Qwen2.5 7B Instruct model for fact checking"""
    ...
    def __init__(self, model_id="Qwen/Qwen2.5-7B-Instruct"):
        ...
        try:
            ...
            # Qwen2.5 has its own pad token, but we can set it if needed
            ...
            print(f"Qwen2.5-7B-Instruct model loaded successfully")
        ...
        with torch.inference_mode(), torch.cuda.amp.autocast():
            outputs = self.model.generate(
                **inputs, 
                ...
                # stopping_criteria=stopping_criteria,  # Uncomment if needed
            )
