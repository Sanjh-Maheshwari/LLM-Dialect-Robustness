...
ADAPTER_DIR = "/scratch/users/k24053411/axolotl/mistral"
...
class MistralClassifier:
    ...
    def __init__(self, model_id="mistralai/Mistral-Small-Instruct-2409"):
        ...
        try:
            ...
            print(f"Mistral-2409 model loaded successfully")
    ...
    def format_prompt(self, instruction: str, context: str = "") -> str:
        """Format prompt using default template"""
    ...
    def predict(self, instruction:str, context:str, dialect: str, task:str, domain:str, max_new_tokens: int = 50) -> str:
        ...
        try:
            ...
            stopping_criteria = StoppingCriteriaList([
                ChatMLStoppingCriteria(self.tokenizer, ["<s>", "</s>"])
            ])
            ...
            logger.error(f"Error in Mistral prediction for dialect {dialect}: {e}")
            return '0'