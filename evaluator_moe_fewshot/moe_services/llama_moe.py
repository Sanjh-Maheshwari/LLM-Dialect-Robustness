...
class LlamaMOEClassifier:
    """Llama MOE classifier with few-shot support"""

    def __init__(self, model_id="meta-llama/Llama-3.2-3B-Instruct", lora_path="/scratch/users/k24053411/"):
        ...
        try:
            ...
            logger.info(f"Llama MOE model loaded successfully with MoE-PEFT")
        except Exception as e:
            logger.error(f"Error loading Llama MOE model: {e}")
            self.model = None
    ...
    def predict_fewshot(self, instruction: str, context: str, few_shot_examples: list,
        ...
        try:
            ...
            logger.error(f"Error in Llama MOE few-shot prediction for dialect {dialect}: {e}")
            return '0'
