...
# Adapter directories
DIALECT_ADAPTER_DIR = "/scratch/users/k24053411/axolotl/mistral"
BASELINE_ADAPTER_DIR = "/scratch/users/k24053411/axolotl/mistral/baseline"
...
class Mistral2409UnifiedClassifier:
    """Unified Mistral-2409 classifier supporting LoRA Grouping, CAT, and TIES methods"""

    def __init__(self, model_id="mistralai/Mistral-Small-Instruct-2409"):
        ...
        try:
            ...
            # Load base model
            self.base_model = MistralForCausalLM.from_pretrained(
                model_id,
            ...
            logger.info(f"Mistral-Small-Instruct-2409 model loaded successfully")

        except Exception as e:
            logger.error(f"Error loading Mistral-2409 model: {e}")
            self.model = None
    ...
    def format_fewshot_prompt(self, instruction: str, few_shot_examples: list, context: str = "") -> str:
        """Format few-shot prompt using tokenizer's chat template
    ...
    def predict(self, instruction: str, context: str, dialect: str,
        ...
        try:
            ...
            stopping_criteria = StoppingCriteriaList([
                ChatMLStoppingCriteria(self.tokenizer, ["<|im_end|>"])
            ])
            ...
            logger.error(f"Error in Mistral-2409 prediction for dialect {dialect}: {e}")
            return '0'
    ...
    def predict_fewshot(self, instruction: str, context: str, few_shot_examples: list,
        ...
        try:
            ...
            logger.error(f"Error in Mistral-2409 few-shot prediction for dialect {dialect}: {e}")
            return '0'
