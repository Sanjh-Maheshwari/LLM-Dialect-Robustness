...
# Adapter directories
DIALECT_ADAPTER_DIR = "./output/axolotl/gemma"
BASELINE_ADAPTER_DIR = "./output/axolotl/gemma/baseline"
...
class Gemma2UnifiedClassifier:
    ...
    def predict_fewshot(self, instruction: str, context: str, few_shot_examples: list,
        ...
        try:
            ...
            logger.error(f"Error in Gemma 2 few-shot prediction for dialect {dialect}: {e}")
            return '0'
