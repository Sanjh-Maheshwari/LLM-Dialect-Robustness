...
# Adapter directories
DIALECT_ADAPTER_DIR = "/scratch/users/k24053411/axolotl/llama"
BASELINE_ADAPTER_DIR = "/scratch/users/k24053411/axolotl/llama/baseline"
...
class LlamaUnifiedClassifier:
    """Unified LLaMA classifier supporting LoRA Grouping, CAT, and TIES methods"""
    ...
    def __init__(self, model_id="meta-llama/Llama-3.1-8B-Instruct"):
        ...
        try:
            ...
            logger.info(f"Llama-3.1-8B-Instruct model loaded successfully")
    ...
    def predict_fewshot(self, instruction: str, context: str, few_shot_examples: list,
        ...
        try:
            ...
            logger.error(f"Error in Llama few-shot prediction for dialect {dialect}: {e}")
            return '0'
