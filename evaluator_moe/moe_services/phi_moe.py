...
class PhiMOEClassifier:
    ...
    def __init__(self, model_id="microsoft/Phi-3-medium-4k-instruct", lora_path="./output/mixlora/phi"):
        ...
        try:
            ...
            logger.error(f"Error loading Phi MOE model: {e}")
            self.model = None
    ...
    def predict_fewshot(self, instruction: str, context: str, few_shot_examples: list,
        ...
        try:
            ...
            logger.error(f"Error in Phi MOE few-shot prediction for dialect {dialect}: {e}")
            return '0'
